...
const char RgbaImageTexture::kVertShaderSource[] =
        "#version 450\n"
...
const char RgbaImageTexture::kFragShaderSource[] =
        "#version 450\n"
...
RgbaImageTexture::RgbaImageTexture(AAssetManager* asset_manager,
...
int RgbaImageTexture::CreatePipeline(const VulkanRenderPass* render_pass) {
...
void RgbaImageTexture::DestroyPipeline() {
...
void RgbaImageTexture::Draw(const VulkanCommandBuffer* command_buffer,
...
void RgbaImageTexture::CreateVertexBuffer() {
...
void RgbaImageTexture::CopyDataToVertexBuffer() {
    void* data;
...
void RgbaImageTexture::CreateTextureImage() {
    ...
    TransitionImageLayout(texture_image_->image(), VK_FORMAT_R8G8B8A8_SRGB,
...
void RgbaImageTexture::CreateTextureImageView() {
...
void RgbaImageTexture::CreateTextureSampler() {
...
void RgbaImageTexture::CreateImage(uint32_t width, uint32_t height, VkFormat format,
...
void RgbaImageTexture::TransitionImageLayout(VkImage image, VkFormat format, VkImageLayout oldLayout,
...
void RgbaImageTexture::CopyBufferToImage(VkBuffer buffer, VkImage image, uint32_t width, uint32_t height) {
    VkCommandBufferAllocateInfo allocInfo{};
    allocInfo.sType = VK_STRUCTURE_TYPE_COMMAND_BUFFER_ALLOCATE_INFO;
    allocInfo.level = VK_COMMAND_BUFFER_LEVEL_PRIMARY;
    allocInfo.commandPool = command_pool_->command_pool();
...
VulkanDescriptorPool*  RgbaImageTexture::CreateDescriptorPool() {
...
VulkanDescriptorSetLayout* RgbaImageTexture::CreateDescriptorSetLayout() const {
...
VulkanDescriptorSet* RgbaImageTexture::CreateDescriptorSet(VulkanDescriptorPool* pool, VulkanDescriptorSetLayout* set_layout) {
    VkDescriptorSetLayout set_layout1 = set_layout->descriptor_set_layout();
    return pool->AllocateDescriptorSet(&set_layout1);
}

void RgbaImageTexture::BindDescriptorSetWithBuffer() const {
...
VulkanPipelineLayout* RgbaImageTexture::CreatePipelineLayout(const VulkanDescriptorSetLayout* descriptor_set_layout) const {
...
VulkanPipeline* RgbaImageTexture::CreateGraphicsPipeline(
...
std::vector<VkPipelineShaderStageCreateInfo> RgbaImageTexture::GetPipelineShaderStageCreateInfos(
...
VkPipelineVertexInputStateCreateInfo RgbaImageTexture::GetPipelineVertexInputStateCreateInfo() const {
...
VkPipelineInputAssemblyStateCreateInfo RgbaImageTexture::GetPipelineInputAssemblyStateCreateInfo() {
...
VkPipelineViewportStateCreateInfo RgbaImageTexture::GetPipelineViewportStateCreateInfo() {
...
VkPipelineRasterizationStateCreateInfo RgbaImageTexture::GetPipelineRasterizationStateCreateInfo() {
...
VkPipelineMultisampleStateCreateInfo RgbaImageTexture::GetPipelineMultisampleStateCreateInfo() {
...
VkPipelineColorBlendStateCreateInfo RgbaImageTexture::GetPipelineColorBlendStateCreateInfo(
...
VkPipelineColorBlendAttachmentState RgbaImageTexture::GetPipelineColorBlendAttachmentState() {
...
VkPipelineDynamicStateCreateInfo RgbaImageTexture::GetPipelineDynamicStateCreateInfo(const std::vector<VkDynamicState>& dynamic_states) {
